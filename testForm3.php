            ...
            switch ($type) {
                case "advertising":
                    ...
                    if ($_POST['advertising-print']) {
                        $body .= "
                    <div class = 'inset' id='formBorder'><strong><em><u>Print</u></em></strong><div class = 'inset'>" .
...
<?php require ('includes/headerFormTest3.php'); ?>
...
<?php require ('includes/footerFormTest3.php'); ?>