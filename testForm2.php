...
<?php require ('includes/headerFormTest2.php'); ?>
				...
				<p><em>Creative Brief Required</em> <span class="required">*</span></p>
                        ...
                        <div class="sub-options">
                            <div class="form-group">
                                ...
                                <div class="sub-options" class="col-md-4">
                                    <div class="form-group">
					...
					<div class="creative-brief">
						...
						<div class="col-md-10">
							<div class="form-group">
								...
								<textarea class="form-control" id="project-outcomes" name="project-outcomes"></textarea>
...
<?php require ('includes/footerFormTest2.php'); ?>
