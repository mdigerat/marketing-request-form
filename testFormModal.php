...
<html>
    <head>
		...
		<link rel = "stylesheet" type = "text/css" href = "css/formsTestBG.css" />
                ...
                <div class="col-md-2">
                    <div class="form-group date">
                        ...
                        <div class="input-group date">
                            <input type="text" class="form-control" id="date" name="date" readonly="readonly" value="mm/dd/yyy"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="quantity" class="control-label heading">Quantity</label><span class="required">&nbsp;*</span>
...
<!-- START TYPES OF PROJECTS -->
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="checkbox" style="margin-top:0">
                            <label>
                                <input type="checkbox" name="type[]" id="advertising" value="advertising" data-toggle="modal" data-target="#creative-brief">
                                Advertising
                            </label>
						</div>
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" id="popup" value="popup" data-toggle="modal" data-target="#creative-brief">
                                Pop Up Display
                            </label>
                        </div>
                        <div class="sub-options">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" value="brochure" id="brochure" data-toggle="modal" data-target="#creative-brief">
                                Brochure
                            </label>
                        </div>
                        <div class="sub-options">
        ...
        Attach final approved content below
                        ...
                        <div class="checkbox" >
                            <label>
                                <input type="checkbox" name="type[]" value="e-postcard" id="e-postcard" data-toggle="modal" data-target="#creative-brief">
                                E-postcard
                            </label>
                        </div>
                        <div class="sub-options">
        ...
        Attach final approved content below
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" id="email-graphic" value="email-graphic" data-toggle="modal" data-target="#creative-brief">
                                Email graphic
                            </label>
                        </div>
                        <div class="sub-options">
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" value="invitation" id="invitation" data-toggle="modal" data-target="#creative-brief">
                                Invitation Package
                            </label>
                        </div>
                        <div class="sub-options">
        ...
        Attach final approved content below
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" value="program" id="program" data-toggle="modal" data-target="#creative-brief">
                                Program
                            </label>
                        </div>
                        <div class="sub-options">
        ...
        Attach final approved content below
                        ...
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="type[]" value="publicity" id="publicity" data-toggle="modal" data-target="#creative-brief">
                                Publicity
                            </label>
                        </div>
                        <div class="sub-options">
...
<div class="modal fade" id="creative-brief">
	<div class="modal-dialog">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header">
				<legend><strong>Creative Brief</strong></legend>
			</div>
		<!-- Modal Body -->
            ...
            <div class="row">
            	<div  class="col-md-10">
					<div class="creative-brief">
                        <div class="form-group">
								<label class="heading control-label"><strong><em><u>Background</u></em></strong></label>  <span class="required">*</span><br>
								<em>Write a description of this project&#8217;s background and the reason for developing it now.</em>
								<textarea class="form-control" id="description" name="description"></textarea>
								<br>
								<em>Which overall College goal will this support?</em>
								<textarea class="form-control" id="goal" name="goal"></textarea>
								<label class="heading control-label"><strong><em><u>Objective</u></em></strong></label>  <span class="required">*</span><br>
								<em>What should this project achieve? What is the goal?
								<br> <strong><u>Example</u></strong>: We want our monthly donors to consider an increase for next year.</em>
								<textarea class="form-control" id="objective" name="objective"></textarea>
								<label class="heading control-label"><strong><em><u>Audience</u></em></strong></label>  <span class="required">*</span><br>
								<em>Which audience do you want this project to engage?<br></em>
						<div class="checkbox">
                            <label>
                                <input type="checkbox" name="prospective-students" id="prospective-students" value="Prospective Students">
                                Prospective Students
                            </label>
                        </div>
						<div class="checkbox">
                            <label>
                                <input type="checkbox" name="current-students" id="current-students" value="Current Students">
                                Current Students
                            </label>
                        </div>
						<div class="checkbox">
						...
						<div class="checkbox">
                            <label>
                                <input type="checkbox" name="faculty-staff" id="faculty-staff" value="Faculty and Staff">
                                Facultyy and Staff
                            </label>
                        </div>
						<div class="checkbox">
                            <label>
                                <input type="checkbox" name="donors-friends" id="donors-friends" value="Donors/Friends">
                                Donors/Friends
                            </label>
                        </div>
						<div class="form-group">
							<label>
								Other
								<input type="text" class="form-control" name="audience-other" id="audience-other" name="Other">
							</label>
						</div>
								<label class="heading control-label"><strong><em><u>Key Message</u></em></strong></label>  <span class="required">*</span><br>
						<div class="col-md-12">
							<div class="form-group">
								<strong>Recipient Thoughts</strong>
								<textarea class="form-control" id="recipient-thoughts" name="recipient-thoughts"></textarea>
								<em>What should the recipient think and do as a result of reading this?<br></em>
							</div>
							<div class="form-group">
								<strong>Call to Action</strong>
								<textarea class="form-control" id="call-to-action" name="call-to-action"></textarea>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="heading control-label"><strong><em><u>Outcomes</u></em></strong></label>  <span class="required">*</span><br>
								<strong>How will you measure the success of this project?</strong>
								<input type="text" class="form-control" id="project-outcomes" name="project-outcomes">
								<em><strong><u>Examples</u></strong>: Attendance, enrollment, donation, analytics, etc.</em><br>
...
<div id="formBorder">
		...
		<div class="row">
            <div class="container-fluid">
                <div class="row">
                    <div class="footer" class="col-md-10 col-md-offset-1">
                        Philadelphia College of Osteopathic Medicine<br>
                        &copy; Copyright 2016                    
					</div>
                </div>
