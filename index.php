...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($fileError || $sizeError) {
        ...
        $subject = "Marketing Request Form" . $_POST['name'];

        $body = "<head><link rel='stylesheet' href='https://webapp.pcom.edu/marketing-request/css/forms.css' /></head><style>.inset {margin-left:30px;}</style>" .
        ...
        foreach ($_POST['type'] as $type) {
            switch ($type) {
                case "advertising":
                    ...
                    <div class = 'inset' id='formBorder'><strong><em><u>Print</u></em></strong><div class = 'inset'>" .
                                ...
                                "<strong><em><u>Delivery:</u></em></strong> " . $_POST['advertising-print-delivery'] . "<br>" .
									"<strong><u>Advertising Creative Brief</u></strong>" . "<br>" .
										"<strong><em><u>Background</u></em></strong>" . "<br>" .
											"<strong><em><u>College Goal:</u></em></strong> " . $_POST['ad-goal'] . "<br>" .
										"<strong><em><u>Objective</u></em></strong>" . "<br>" .
											"<strong><em><u>Objective:</u></em></strong> " . $_POST['ad-objective'] . "<br>" .
										"<strong><em><u>Audience</u></em></strong>" . "<br>" .
											"<strong><em><u>Prospective Students:</u></em></strong> " . $_POST['ad-prospective-students'] . "<br>" .
											"<strong><em><u>Students:</u></em></strong> " . $_POST['ad-current-students'] . "<br>" .
											"<strong><em><u>Alumni:</u></em></strong> " . $_POST['ad-alumni'] . "<br>" .
											"<strong><em><u>Faculty and Staff:</u></em></strong> " . $_POST['ad-faculty-staff'] . "<br>" .
											"<strong><em><u>Donors/Friends:</u></em></strong> " . $_POST['ad-donors-friends'] . "<br>" .
											"<strong><em><u>Other:</u></em></strong> " . $_POST['ad-audience-other'] . "<br>" .
										"<strong><em><u>Key Message</u></em></strong>" . "<br>" .
											"<strong><em><u>Recipient Thoughts:</u></em></strong> " . $_POST['ad-recipient-thoughts'] . "<br>" .
											"<strong><em><u>Call to Action:</u></em></strong> " . $_POST['ad-call-to-action'] . "<br>" .
										"<strong><em><u>Key Message</u></em></strong>" . "<br>" .
											"<strong><em><u>Outcomes:</u></em></strong> " . $_POST['ad-project-outcomes'] . "<br>" .
                                "</div></div>";
                    }
                ...
                case "brochure":
                    $body .= "Brochure<br>" .
									"<strong><u>Brochure Creative Brief</u></strong>" . "<br>" .
										"<strong><em><u>Background</u></em></strong>" . "<br>" .
                ...
                case "logo":
                    $body .= "Logo<br>" .
									"<strong><u>Logo Creative Brief</u></strong>" . "<br>" .
										"<strong><em><u>Background</u></em></strong>" . "<br>" .
    ...
    <div class="col-md-12">
        <form id="requestForm" enctype="multipart/form-data" method="post">
		  <div id="formBorder">
			...
			<!--
			<div class="alert alert-danger" role="alert" style="display: none" id="error-box-na">
				<span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> na is not a valid input.
			</div>
			-->
            	...
            	<div  class="col-md-12">
					<div class="ad-creative-brief">
                        <div class="form-group">
								...
								<label class="heading control-label"><strong><em><u>Background</u></em></strong></label>  <span class="required">*</span>
								<br>
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="heading control-label"><strong><em><u>Key Message</u></em></strong></label><br>
...
<script>
    ...
    $("form").submit(function () {
        ...
        $("#error-box").hide();
        /*
        $(".form-group").removeClass('has-error-na');
        $("#error-box-na").hide();
        */
        //check text fields
        ...
        /*
        //check input for na
        var fields = ['name', 'email', 'department', 'proof-to', 'deliver-to', 'project-name'];
        for (key in fields) {
            if (!$("#" + fields[key] + "na").val()) {
                $("#" + fields[key]).parents('.form-group').addClass('has-error-na');
                error = true;
            }
        }
        */
